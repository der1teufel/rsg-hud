    ...
    methods: {
        hudTick(data) {
            ...
            if (parseInt(data.stamina) <= 30 ) {
              this.showStaminaColor = "#fbcd7e";
            } else {
                this.showStaminaColor = "#FFF";
            }
            if (data.hunger <= 30) {
                this.showHungerColor = "#fbcd7e";
            } else {
                this.showHungerColor = "#FFF";
            }
            if (data.thirst <= 30 ) {
                this.showThirstColor = "#fbcd7e";
            } else {
                this.showThirstColor = "#FFF";
            }
            if (data.cleanliness <= 30 ) {
                this.showCleanlinessColor = "#fbcd7e";
            } else {
